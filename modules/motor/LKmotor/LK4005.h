...
#define LK_MOTOR_ENABLE    0x88
#define LK_MOTOR_STOP      0x80
#define LK_READ_ONLY       0x9C
#define LK_MOTOR_TORQUE    0xA1
...
typedef struct
{
    ...
    // LK电机要停止后要重新使能
    Motor_Working_Type_e last_flag;
    Motor_Working_Type_e current_flag;
